ESP_A публікує данні температуру та вологість на топік iot-course/vlasenko/sensors та команду мигання LED на топік iot-course/vlasenko/commands на брокер hivemq.com. І там і там використовується QoS 0, бо PubSubClient підтримує publish тільки з ним.
На випадок проблем з данними DHT показники преевіряються isnan і данні заміняються на "null".

![HIVEMQTT](image/MQTTClient.png)

ESP_B підписується на ці обидва топіки з QoS 1, отримує данні температури та вологості, виводить їх в Serial та курує LED в залежності від отриманої температури (ON при високій температурі, OFF при низькій).
